...
from pythonmusic.music import Chord, Note, Part, Phrase, Score, legato

# FIXME: PPQ was redefined
...
#
#         self.assertEqual(pe_to_midi(a, 0, 0), ([t_on, t_off], 96))
#
...
#                 Message.new_note_off(0, 60, 10, 86),
#                 Message.new_note_on(0, 40, 10, 10),
#                 Message.new_note_on(0, 50, 10, 0),
#                 Message.new_note_on(0, 60, 10, 0),
#                 Message.new_note_off(0, 40, 10, 86),
#                 Message.new_note_off(0, 60, 10, 0),
#                 Message.new_note_off(0, 50, 10, 87),
#                 Message.new_note_on(0, 60, 10, 19),
#                 Message.new_note_off(0, 60, 10, 86),
#             ],
#         )
#
...
#             Message.new_note_off(0, 60, 10, 806),
#             Message.new_note_on(0, 61, 10, 100),
#             Message.new_note_off(0, 61, 10, 860),
#         ]
#
#         part_b = Part("B", channel=1)
#         part_b.add_phrase(Phrase([Note(60, 4.0, 10), Note(70, 1.0, 10)]), 15.0)
#         msg_b = [
#             Message.new_note_on(1, 60, 10, 14400),
#             Message.new_note_off(1, 60, 10, 3460),
#             Message.new_note_on(1, 70, 10, 380),
#             Message.new_note_off(1, 70, 10, 860),
#         ]
#
