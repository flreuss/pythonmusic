...
class IrPayload(ABC):
    ...
    A payload is one abstraction above midi messages. It retains some objects
    such as notes instead of splitten them into on/off messages.
    """
...
class IrNote(IrPayload):
    __slots__ = ("note", "velociry", "curation")
