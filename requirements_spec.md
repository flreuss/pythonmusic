...
- [X] [MidiSequence](https://jythonmusic.me/api/midisequence/) {4}
...
- [X] mit OSC-fähigen Geräten kommunizieren _(siehe OSCIn/Out). {2}_
- [ ] ~MIDI-Datei als Score importieren. {1}~
- [X] [Metronome](https://jythonmusic.me/metronome/) {1}
